...
class ActionLayer(BaseActionLayer):
    ...
    def _inconsistent_effects(self, actionA, actionB):
        ...
        return any([~a in actionA.effects for a in actionB.effects] + [~a in actionB.effects for a in actionA.effects])
    ...
    def _interference(self, actionA, actionB):
        ...
        # TODO: implement this function
        # raise NotImplementedError
        return not (not any([~a in actionA.preconditions for a in actionB.effects]) and not any(
            [~a in actionB.preconditions for a in actionA.effects]))
    ...
    def _competing_needs(self, actionA, actionB):
        ...
        # TODO: implement this function
        # raise NotImplementedError
        return any(self.parent_layer.is_mutex(itemA, itemB) for itemA in actionA.preconditions for itemB in
                   actionB.preconditions) \
               or any(self.parent_layer.is_mutex(itemB, itemA) for itemA in actionA.preconditions for itemB in
                      actionB.preconditions)
...
class LiteralLayer(BaseLiteralLayer):
    ...
    def _inconsistent_support(self, literalA, literalB):
        ...
        # TODO: implement this function
        # raise NotImplementedError
        return all(self.parent_layer.is_mutex(actionA, actionB) for actionA in self.parents[literalA] for actionB in
